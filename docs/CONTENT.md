...
| Press Kit | Draft / User Review | `references/LvbResult` 승인 원본에서 브랜드 5개·MushHero 7개·MushDash 6개를 유지하며, 기존 공개 URL의 ZIP 3개에는 Brand README/Guide와 두 게임의 EN·KO·JA·ZH-CN Fact Sheet/README를 제공한다. 화면은 대표 키아트·공식 게임 이미지와 locale boilerplate 복사를 유지하고 Recent Press는 표시하지 않는다. source·SHA·ZIP 내용과 갱신 절차는 `PRESS_KIT.md`를 따른다. |
