...
- site는 Home·Our Games·About·Contact·News·MushHero·MushDash·Privacy·Terms의 4개 locale 명시적 static route와 sitemap을 생성한다. Privacy·Terms 각 4개와 404는 sitemap에서 제외한다. React/Vue/Svelte, SSR, adapter, Functions, Edge, DB, CMS는 사용하지 않는다.
