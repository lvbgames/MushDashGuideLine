...
export const pressTranslations: PressTranslations = {
  en: {
    ...
    metaDescription: 'Official Lv.B studio information, game facts, brand assets, screenshots, recent coverage and press contact.',
    ...
    gamesTitle: 'MushHero and Mush Dash',
    ...
    downloadLabels: { brand: 'Lv.B Brand Assets', mushhero: 'MushHero Press Kit', mushdash: 'Mush Dash Press Kit' },
  ...
  ko: {
    ...
    metaDescription: 'Lv.B 스튜디오와 게임의 공식 정보, 브랜드 자료, 스크린샷, 최근 보도와 언론 문의처를 확인하세요.',
    heroEyebrow: 'Press Kit',
    ...
    gamesEyebrow: '현재 게임',
    gamesTitle: 'MushHero와 Mush Dash',
    ...
    downloadLabels: { brand: 'Lv.B 브랜드 자산', mushhero: 'MushHero 프레스 키트', mushdash: 'Mush Dash 프레스 키트' },
  ...
  ja: {
    ...
    metaDescription: 'Lv.Bとゲームの公式情報、ブランド素材、スクリーンショット、最近の掲載情報、メディア向け連絡先をご案内します。',
    heroEyebrow: 'Press Kit',
    ...
    downloadLabels: { brand: 'Lv.Bブランド素材', mushhero: 'MushHeroプレスキット', mushdash: 'Mush Dashプレスキット' },
  ...
  'zh-cn': {
    ...
    metaDescription: '查看 Lv.B 与旗下游戏的官方信息、品牌素材、游戏截图、近期报道及媒体联系方式。',
    heroEyebrow: 'Press Kit',
    ...
    copyFailed: '复制失败',
    gamesEyebrow: '当前游戏',
    gamesTitle: 'MushHero 与 Mush Dash',
    ...
    downloadZip: '下载 ZIP',
    downloadLabels: { brand: 'Lv.B 品牌素材', mushhero: 'MushHero 媒体资料包', mushdash: 'Mush Dash 媒体资料包' },
